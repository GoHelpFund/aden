...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Help address\n"
            "  payee          - Print the masternode payout Help address (can be additionally filtered,\n"
            "                   partial match)\n"
            ...
            "  votingaddress  - Print the masternode voting Help address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "help",               "masternode",             &masternode,             true,  {} },
    { "help",               "masternodelist",         &masternodelist,         true,  {} },
    { "help",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "help",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "help",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "help",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
