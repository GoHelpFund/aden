// Copyright (c) 2014-2018 The Help Core developers
...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Help related functionality
...
/*
    ...
    allow endless transaction that would bloat Help and make it unusable. To
