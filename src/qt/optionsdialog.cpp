    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HELP-light"), QVariant("light"));
    ui->theme->addItem(QString("HELP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HELP-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("HELP-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("HELP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HELP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HELP-traditional"), QVariant("trad"));
