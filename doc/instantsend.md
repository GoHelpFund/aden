...
This mechanism has been integrated into Bitcore-Node-Help which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/helppay/insight-api-help#web-socket-api](https://github.com/helppay/insight-api-help#web-socket-api)
* API: [https://github.com/helppay/insight-api-help#instantsend-transactions](https://github.com/helppay/insight-api-help#instantsend-transactions)
