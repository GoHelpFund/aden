...
This document provides guidelines for internationalization of the Help Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `help_en.ts` remains unchanged.
