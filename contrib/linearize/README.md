# Linearize
Construct a linear, no-fork, best version of the Help blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install help_hash

https://github.com/gohelpfund/aden_hash
...
JSON-RPC server. Running `helpd` or `help-qt -server` will be sufficient.
...
* `input`: helpd blocks/ directory containing blkNNNNN.dat
